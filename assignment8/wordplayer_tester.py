...
wordplayer tester for python and C++
...
print('... running **preliminary** tests of',sourcecode)
...
EleganceGoals= {'py':100,'cpp':300}
EfficiencyGoals = {'py':2.0,'cpp':0.2}
...
if __name__ == '__main__':
    ...
    print('total score',sum(Grades),'out of 6.0')
